			...
			public function check_update( $transient ) {
				...
				if ( ! empty( $remote_version ) && version_compare( $this->current_version, $remote_version->new_version, '<' ) ) {
					...
					$information->icons       = array(
						'2x' => sprintf( 'https://ps.w.org/woo-variation-gallery/assets/icon-256x256.png', $this->free_plugin_slug ),
						'1x' => sprintf( 'https://ps.w.org/woo-variation-gallery/assets/icon-128x128.png', $this->free_plugin_slug ),
