...
import { SearchBox, StyledSurface } from '../styles';
...
function LogsMain() {
	...
	const { totalPages, selectedLog, logs, currentPage } = useSelect( ( select ) => ( {
	...
	const { populateLogs, setCurrentPage, selectLog } =
		useDispatch( LogsStore );
