				...
				<StyledSurfaceHeader>
					...
					<Text>
						{ createInterpolateElement(
							__( 'Mailgun is a comprehensive email automation platform with APIs for sending, receiving, and tracking emails. For pricing information <pricing>visit here</pricing>. For configuration information, <help>visit here</help>.', 'LION' ),
							{
								// eslint-disable-next-line jsx-a11y/anchor-has-content
								pricing: <a href="https://go.solidwp.com/mail-mailgun-pricing" rel="noreferrer" target="_blank" />,
								// eslint-disable-next-line jsx-a11y/anchor-has-content
								help: <a href="https://go.solidwp.com/mail-mailgun-config" rel="noreferrer" target="_blank" />,
							}
						) }
					</Text>
				</StyledSurfaceHeader>
